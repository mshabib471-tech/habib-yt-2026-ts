  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <form onSubmit={login} className="bg-white/10 p-6 rounded-xl w-80 space-y-3">
        ...
        <button className="w-full bg-orange-500 py-2 rounded font-semibold">Login</button>
        <button type="button" onClick={google} className="w-full bg-blue-500 py-2 rounded font-semibold">Login with Google</button>
      </form>
